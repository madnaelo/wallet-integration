...
export function GrowthPage({ page, guide = false }: { page: PageContent; guide?: boolean }) {
  ...
  return <main className={styles.page}>
    ...
    <section className={`${styles.band} ${styles.pilot}`} aria-labelledby="next-step"><h2 id="next-step">Check the fit for your product.</h2>
      <p>Tell us your product, audience and required networks. We will review existing capabilities and scope the integration before proposing a paid pilot. Provider approvals, operating permissions and infrastructure remain the operator&apos;s responsibility.</p>
